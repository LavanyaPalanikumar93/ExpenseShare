...
export const GroupUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    if (values.adminId !== undefined && typeof values.adminId !== 'number') {
      values.adminId = Number(values.adminId);
    }
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...groupEntity,
          members: groupEntity?.members?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="passionApp.group.home.createOrEditLabel" data-cy="GroupCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Admin Id" id="group-adminId" name="adminId" data-cy="adminId" type="text" />
              <ValidatedField label="Members" id="group-members" data-cy="members" type="select" multiple name="members">
                <option value="" key="0" />
                {userProfiles
