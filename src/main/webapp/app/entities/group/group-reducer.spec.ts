...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GROUP actions', async () => {
      const arg = 42666;
