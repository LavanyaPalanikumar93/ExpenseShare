...
export const UserProfileUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...userProfileEntity,
          groups: userProfileEntity?.groups?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="passionApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Groups" id="user-profile-groups" data-cy="groups" type="select" multiple name="groups">
                <option value="" key="0" />
                {groups
