...
import static com.lavanya.domain.UserProfileAsserts.*;
...
import com.lavanya.domain.UserProfile;
import com.lavanya.repository.UserProfileRepository;
...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().email(DEFAULT_EMAIL);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().email(UPDATED_EMAIL);
        return userProfile;
    }
